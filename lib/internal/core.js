...
exports.fetchPayment = function (params, callback) {
    ...
    exports.fetchPaymentAsync(params)
 ...
 *
 */
exports.fetchPaymentAsync = function (params) {
    params = params || {};
...
exports.prepareOrder = function (order, paymentMethod, callback) {
    ...
    exports.prepareOrderAsync(order, paymentMethod)
        .then(function(order) { callback(null, order); })
        .catch(function(err) { callback(err, null); });
 ...
 *
 */
exports.prepareOrderAsync = function (order, paymentMethod) {
...
exports.submitPayment = function(order, paymentData, callback) {
    ...
    exports.submitPaymentAsync(order, paymentData)
        .then(function(data) { callback(null, data.reference, data.transaction); })
 ...
 *
 */
exports.submitPaymentAsync = function (order, paymentData) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                var parseResponse = function (err, resp, body) {
                    if(err) {
                        ...
                        resolve({reference: reference, transaction: transaction});
                    }
                };
