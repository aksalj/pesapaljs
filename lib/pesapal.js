 ...
 * @param callback
 */
PesaPal.getPaymentStatus = function (options, callback) {
 ...
 * @deprecated
 */
PesaPal.paymentStatus = PesaPal.getPaymentStatus;
 ...
 * @param callback
 */
PesaPal.getPaymentDetails = function (options, callback) {
 ...
 * @deprecated
 */
PesaPal.paymentDetails = PesaPal.getPaymentDetails;
