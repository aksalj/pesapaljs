...
exports.getPaymentURL = function (order) {
    ...
    var url = DIRECT_ORDER_URL + "?" + DATA_KEYS.request + "=" + encodeURIComponent(xmlEntities.encode(order.toXML()));
    oauth.get(url, null, null, function(err, data, response) {
